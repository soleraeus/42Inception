...
fclean: clean
	cd srcs ; \
	sudo docker rm -f mariadb wordpress nginx proftpd redis adminer; \
	sudo docker rmi -f mariadb:inception wordpress:inception nginx:inception proftpd:inception redis:inception adminer:inception; \
